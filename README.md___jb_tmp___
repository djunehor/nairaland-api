...
* GET: `/users/<user>/topics`

AUTHENTICATED ROUTES
* GET: `/user/followed_boards`
* GET: `/user/followed_topics`
* GET: `/user/likes_and_shares`
* GET: `/user/mentions`
* GET: `/user/following_posts`
* GET: `user/shared_with`
* POST: `user/topics/<board>/new`
* POST: `user/posts/<topic>/new`
* POST: `user/posts/like`
* POST: `user/posts/share`
